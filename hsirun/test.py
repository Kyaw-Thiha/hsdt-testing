...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-t", "--testset", nargs="+", default=["icvl_512_50"], help="testset"
    )
    ...
    parser.add_argument(
        "--clamp", action="store_true", help="whether clamp input into [0, 1]"
    )
    parser.add_argument(
        "-kp",
        "--key_path",
        default="net",
        help="key path to access network state_dict in ckpt",
    )
